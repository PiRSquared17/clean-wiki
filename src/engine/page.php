...
define('PERMISSION_VERSION_MERGE', 1);

define('PERMISSION_PAGE_MODIFY', 1);

define('PERMISSION_PERMISSIONS_GET', 1);
define('PERMISSION_PERMISSIONS_SET', 1);

//Exceptions
define('EXCEPTION_ACCESS_DENIED', 1);
define('EXCEPTION_INVALID_PARAMETER', 1);
